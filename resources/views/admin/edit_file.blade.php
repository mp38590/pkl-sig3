...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/js/bootstrap.bundle.min.js"></script>
    ...
    <main class="main-content max-height-vh-100 h-100">
        ...
        <h3 class="font-weight-bold mb-0">Edit File Dokumen Assessment</h3>
                    ...
                    <div class="card card-body pt-4 p-3">
                        ...
                        <div class="form-group">
                            ...
                            <div class="@error('file') border border-danger rounded-3 @enderror">
                                <div class="mb-3">
                                    <input class="form-control" type="file" name="file" id="file" placeholder="{{ $dokumen->nama_dokumen }}" value="{{ old('nama_dokumen') }}">
                                </div>
                            </div>
