<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 bg-slate-900 fixed-start " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse px-4  w-auto mt-5" id="sidenav-collapse-main">
        ...
        @if (auth()->user()->level=="Karyawan")
            <li class="nav-item">
                <a class="nav-link  {{ is_current_route('dashboard_karyawan') ? 'active' : '' }}"
                    href="{{ route('dashboard_karyawan') }}">
                    <div
            ...
            <li class="nav-item">
                <a class="nav-link  {{ is_current_route('entry_dokumen') ? 'active' : '' }}" href="{{ route('entry_dokumen') }}">
                    <div
                        class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">
                        <svg width="30px" height="30px" viewBox="0 0 48 48" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            <li class="nav-item">
                <a class="nav-link {{ is_current_route('detail_dokumen') ? 'active' : '' }} " href="{{ route('detail_dokumen') }}">
                    <div
                        class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">
                        <svg width="30px" height="30px" viewBox="0 0 48 48" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
        ...
        @if (auth()->user()->level=="Admin")
            <li class="nav-item">
                <a class="nav-link  {{ is_current_route('dashboard_admin') ? 'active' : '' }}"
            ...
            <li class="nav-item">
                <a class="nav-link  {{ is_current_route('verifikasi_dokumen') ? 'active' : '' }}" href="{{ route('verifikasi_dokumen') }}">
                    <div
                        class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">
                        <svg width="30px" height="30px" viewBox="0 0 48 48" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    ...
                    <span class="nav-link-text ms-1">Verifikasi Dokumen</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ is_current_route('data_pengguna') ? 'active' : '' }} " href="{{ route('data_pengguna') }}">
                    <div
                        class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">
                        <svg width="30px" height="30px" viewBox="0 0 48 48" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
