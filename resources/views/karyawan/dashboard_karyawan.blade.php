                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="w-100">
                                        ...
                                        <h4 class="mb-2 font-weight-bold">5 Dokumen</h4>
                                        <div class="d-flex align-items-center">
                                            <span class="text-sm text-success font-weight-bolder">
                                                <i class="fa fa-chevron-up text-xs me-1"></i>10.5%
                                            </span>
                                            <span class="text-sm ms-1">dari 10 Dokumen</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card border shadow-xs mb-4">
                        <div class="card-body text-start p-3 w-100">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="w-100">
                                        <p class="text-sm text-secondary mb-1">Jumlah Pengguna Terdaftar</p>
                                        <h4 class="mb-2 font-weight-bold">5 Pengguna</h4>
                                        <div class="d-flex align-items-center">
                                            <span class="text-sm text-success font-weight-bolder">
                                                <i class="fa fa-chevron-up text-xs me-1"></i>20%
                                            </span>
                                            <span class="text-sm ms-1">dari 20 Pengguna</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
