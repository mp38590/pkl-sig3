                            ...
                            <table class="table align-items-center mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <a href="{{ route('edit_variabel', ['id' => $variabel->id]) }}" class="btn btn-warning btn-sm position-relative mt-1 mb-1 text-center" style="width: 40px; height: 32px;">
                                                <img src="../assets/img/small-logos/tool.png" alt="Logo" class="position-absolute start-50 top-50 translate-middle"
                                                    style="width: 15px; height: 15px;">
                                        </a> <br>
                                        <a href="{{ route('hapus_variabel', ['id' => $variabel->id]) }}" class="btn btn-danger btn-sm position-relative mt-1 mb-1 text-center" style="width: 40px; height: 32px;">
