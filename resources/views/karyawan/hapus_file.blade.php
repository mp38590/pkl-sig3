                ...
                <div class="col-md-8 mx-auto mb-3 card-center">
                    <div class="card shadow-s border mb-4">
                        <div class="card-body pt-4 p-3">
                            <form role="form" method="POST" action="{{ route('konfirm_hapus_file', ['id_variabel_penilaian' => $dokumen->id_variabel_penilaian, 'nama_dokumen' => $dokumen->nama_dokumen]) }}" enctype="multipart/form-data">
                            @csrf
