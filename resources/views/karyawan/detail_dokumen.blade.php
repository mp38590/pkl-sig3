                ...
                <div class="col-md-12 mb-6">
                    <div class="card shadow-s border mb-4">
                        <div class="d-flex justify-content-end">
                            <a href="{{ route('tambah_dokumen') }}" class="btn btn-light btn-sm position-relative btn-md mt-3 mb-3 me-3 font-weight-semibold" style="border: 2px solid #35A8CC;">+ Tambah
                            </a>
                        </div>
                            ...
                            <table class="table align-items-center mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <th class="font-weight-normal text-xl text-dark ps-1 text-center">{{ $detail->nilai }}</th>
